                                        ...
                                        <form>
                                            ...
                                            <div className="d-flex align-items-center justify-content-between mb-0">
                                                <div className="form-check">
                                                    ...
                                                    <label className="form-check-label" for="checkRememberPassword">Remember password</label>
                                                </div>
                                                <button onClick={() => handleLogin(email, password)} className="btn btn-primary" type="button"> Login</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
